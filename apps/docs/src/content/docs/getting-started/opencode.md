...
If the entry exists but does not launch correctly, compare the stored command and environment values against [/reference/troubleshooting/](/reference/troubleshooting/).
